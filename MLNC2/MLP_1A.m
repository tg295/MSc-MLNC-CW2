...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% This code is based on the classic gradient descent backpropagation.
%
function [accuracy, best_prediction] = MLP_1A(train_samples, train_labels, test_samples, test_labels, nbrOfNeuronsInEachHiddenLayer, learningRate, nbrOfEpochs_max, enable_decrease_learningRate, learningRate_decreaseValue, min_learningRate)
...
for Epoch = 1:nbrOfEpochs_max
    ...
    %% Compute delta weighs using classic backpropagation method (do not modify)
    ...
    %% Decrease Learning Rate (do not modify)
    ...
    disp([int2str(Epoch) ' Epochs done out of ' int2str(nbrOfEpochs_max) ' Epochs. Accuracy = ' num2str(mean(accuracy(Epoch))) ' Learning Rate = ' ...
